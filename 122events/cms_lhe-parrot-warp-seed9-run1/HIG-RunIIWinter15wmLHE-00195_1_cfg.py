...
# with command line options: Configuration/GenProduction/python/HIG-RunIIWinter15wmLHE-00195-fragment.py --fileout file:HIG-RunIIWinter15wmLHE-00195ND.root --mc --eventcontent LHE --datatier LHE --conditions MCRUN2_71_V1::All --step LHE --python_filename HIG-RunIIWinter15wmLHE-00195_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 1649
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(1649)
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIIWinter15wmLHE-00195-fragment.py nevts:1649'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIIWinter15wmLHE-00195ND.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    nEvents = cms.untracked.uint32(1649),
